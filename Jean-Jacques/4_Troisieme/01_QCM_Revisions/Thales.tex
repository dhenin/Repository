...
\AQquestion[br=3]{\setbox2=\hbox{\begin{minipage}[t]{5cm}
...
\end{tabular}
 ...
 \AQquestion[br=1]{$ABC$ est un triangle tel que $AB=3cm$ et $AC=4cm$.\\
 ...
 \AQquestion[br=1]{Avec les données ci-dessous\ldots\\
