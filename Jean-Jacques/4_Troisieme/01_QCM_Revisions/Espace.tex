...
\fi
 ...
 \AQquestion[br=1]{$P$ est un point de la boule de centre $A$ et de rayon $5cm$. Donc\ldots}{%
 {$AP \leqslant 5 $},
 {$AP >5 $},
 {$AP \leqslant 10$}
 }
 ...
 \AQquestion[br=3]{L'aire d'une sphère de rayon $R$ est\ldots}{%
 {$\dfrac{4}{3}\pi R^3$},
 {$\dfrac{4}{3}\pi R^2$},
 {$4 \pi R^2$}
 }
...
{un rectangle},
 ...
 \AQquestion[br=1]{La section d'un cylindre de révolution  par un plan parallèle à axe est\ldots}{%
