...
\fi
 ...
 \AQquestion[br=2]{On ne peut calculer la racine carrée d'un nombre téel $a$ que si\ldots}
  {%
 ...
 \AQquestion[br=1]{Si $a$ désigne un nombre réel positif, alors $\sqrt{a}$ désigne\ldots}{%
 ...
 \AQquestion[br=2]{$3\sqrt{20} - \sqrt{45}  \sqrt{5}$ peut s'écrire sous la forme\ldots}{%
   ...
   {$a\sqrt{2} + b\sqrt{5}$ avec $a$ et $b$ nombres entier.s}
 }  
