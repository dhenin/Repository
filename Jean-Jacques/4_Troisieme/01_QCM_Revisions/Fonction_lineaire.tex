...
\fi
 ...
 \AQquestion[br=3]{Pour calculer l'image d'un nombre $x$ par la fonction linéaire de coefficient directeur égal à  4\ldots}{%
 {on additionne 4 à $x$,},
 {on divise $x$ par 4,},
 ...
 \AQquestion[br=1]{Si $f$ est une fonction linéaire,\\
alors l'écriture $f(2)=\dfrac{5}{4}$ signifie\ldots}
  {%
 ...
 \AQquestion[br=1]{Dans un repère, la représentation graphique de la fonction linéaire de coefficient directeur $a$ passe le point de coordonnées\ldots}
  {%
   {$(1;a)$,},
    {$(a;1)$,},
    {$(a;a)$.}
...
\end{tikzpicture}}}\\
 \vspace*{-1.1cm} linéaire de coefficient\ldots\\
  ...
  \AQquestion[br=2]{Par la fonction ci-dessus, l'image de -2\ldots}{%
  ...
  \AQquestion[br=2]{On agrandit un prisme droit dans le rapport $\dfrac{\sqrt{3}}{1}$.\\
