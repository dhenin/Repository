...
\fi
 ...
 \AQquestion[br=3]{Si $f$ est la fonction affine $\quad x\longmapsto -2x +1$. \\
 ...
 \AQquestion[br=3]{Une droite de coefficient directeur -1 est tracée sur la figure\ldots}{%
{\raisebox{-1.5cm}{
...
\end{tikzpicture}}
 ...
 \AQquestion[br=2]{Soit $f$  la fonction affine $x\longmapsto 3x -1$.\\
 ...
 \AQquestion[br=2]{Soit $f$  la fonction affine $x\longmapsto 2x + 5$.\\
 ...
 \AQquestion[br=1]{Soit $f$ une fonction affine.\\
